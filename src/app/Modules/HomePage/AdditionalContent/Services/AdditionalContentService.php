...
namespace App\Modules\HomePage\AdditionalContent\Services;

use App\Http\Services\FileService;
use App\Modules\HomePage\AdditionalContent\Models\AdditionalContent;
...
class AdditionalContentService
{
    ...
    {
        return Cache::remember('home_page_additional_main', 60*60*24, function(){
...
class CommonFilter implements Filter
{
    public function __invoke(Builder $query, $value, string $property)
    {
        ...
        ->orWhere('sub_heading', 'LIKE', '%' . $value . '%')
