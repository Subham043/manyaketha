...
namespace App\Modules\AboutPage\About\Services;

use App\Http\Services\FileService;
use App\Modules\AboutPage\About\Models\About;
...
class AboutService
{
    ...
    {
        return Cache::remember('about_page_about_main_'.$id, 60*60*24, function() use($id){
