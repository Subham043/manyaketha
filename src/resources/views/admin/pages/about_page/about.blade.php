...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'About', 'page_link'=>route('about_page.about.get'), 'list'=>['Update']])
        <!-- end page title -->

        <div class="row" id="image-container">
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('about_page.about.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
 ...
 .addField('#sub_heading', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('about_page.about.post')}}', formData)
