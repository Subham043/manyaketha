...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('admin.includes.breadcrumb', ['page'=>'Additional Content', 'page_link'=>route('about_page.additional_content.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->

        <div class="row" id="image-container">
            @include('admin.includes.back_button', ['link'=>route('about_page.additional_content.paginate.get')])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('about_page.additional_content.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.input', ['key'=>'sub_heading', 'label'=>'Sub-Heading', 'value'=>$data->sub_heading])
                                    </div>
                                    <div class="col-xxl-4 col-md-4">
...
.addField('#sub_heading', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('about_page.additional_content.update.post', $data->id)}}', formData)
