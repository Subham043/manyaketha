...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('admin.includes.breadcrumb', ['page'=>'Additional Content', 'page_link'=>route('about_page.additional_content.paginate.get'), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('about_page.additional_content.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('about_page.additional_content.create.post')}}', formData)
