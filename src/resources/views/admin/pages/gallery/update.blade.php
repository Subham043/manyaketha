...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list campaigns')
        @include('admin.includes.breadcrumb', ['page'=>'Gallery', 'page_link'=>route('gallery.paginate.get', $campaign_id), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row" id="image-container">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('gallery.update.post', [$campaign_id, $data->id])}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
.addField('#image_title', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('gallery.update.post', [$campaign_id, $data->id])}}', formData)
