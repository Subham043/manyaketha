...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Additional Service', 'page_link'=>route('service_page.additional_service.paginate.get', $service_id), 'list'=>['Create']])
        <!-- end page title -->

        <div class="row">
            @include('admin.includes.back_button', ['link'=>route('service_page.additional_service.paginate.get', $service_id)])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('service_page.additional_service.create.post', $service_id)}}" enctype="multipart/form-data">
                @csrf
                <div class="card">
...
.addField('#name', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('service_page.additional_service.create.post', $service_id)}}', formData)
