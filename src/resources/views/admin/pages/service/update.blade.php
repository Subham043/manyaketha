...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list services')
        @include('admin.includes.breadcrumb', ['page'=>'Service', 'page_link'=>route('service.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row" id="image-container">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('service.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('service.update.post', $data->id)}}', formData)
