...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('admin.includes.breadcrumb', ['page'=>'Additional Content', 'page_link'=>route('home_page.additional_content.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row" id="image-container">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('home_page.additional_content.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
.addField('#sub_heading', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('home_page.additional_content.update.post', $data->id)}}', formData)
